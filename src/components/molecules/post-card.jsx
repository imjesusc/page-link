...
export const PostCard = ({ link, post, postTitle, imgPost }) => {
	return (
		<a href={link} aria-label={post} target="_blank" rel="noreferrer">
			<article className="flex flex-col bg-card dark:bg-accent-foreground hover:scale-[1.01] transition-transform duration-500  gap-2 border-transparent rounded-xl shadow-medium p-4 overflow-hidden">
