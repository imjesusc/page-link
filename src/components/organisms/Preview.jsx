...
export const Preview = () => {
  ...
  return (
    <div className={cn('aspect-[1/2] bg-white h-full w-auto rounded-[50px] ring-8',
      ' ring-slate-800 overflow-hidden')}
    >
      <div className='overflow-y-auto px-4 py-10 flex flex-col gap-4 h-full w-full'>
